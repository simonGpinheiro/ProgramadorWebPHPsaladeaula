...
if($idCliente > 0){
    ...
    $sql_code = "UPDATE cliente SET nome = '$nome', data_nascimento = '$data_nascimento', orgao = '$orgao', rg = '$rg', cpf = '$cpf', estado_civil = '$estado_civil', sexo = '$sexo', email = '$email', senha = '$senha' WHERE idcliente = '$idCliente' ";
